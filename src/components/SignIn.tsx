...
import { setUserSession, UserType } from '../util/common';
import KidKredCoinsImage from '../images/kreds.png';
...
export default function SignInSide() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
        ...
        const signInResult = await loginService.signInUser(userEmail, userPassword);
    ...
    <ThemeProvider theme={theme}>
      <Grid container component="main" sx={{ height: '100vh' }}>
        ...
        <Grid
          ...
          md={7}
          sx={{
            backgroundImage: `url(${KidKredCoinsImage})`,
